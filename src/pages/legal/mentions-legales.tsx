  ...
  return (
    <Layout>
      <div className="container mx-auto px-4 py-16">
        <h1 className="text-4xl font-bold mb-8 text-text-primary">Mentions Légales</h1>
        
        <div className="space-y-8 text-text-secondary">
          <section>
            <h2 className="text-2xl font-semibold mb-4 text-text-primary">1. Informations légales</h2>
            ...
            <ul className="list-disc ml-6 mt-2 space-y-2">
              ...
              <li>Email : contact@tolarys.fr</li>
              <li>Directeur de la publication : Mattias Mathevon</li>
            </ul>
          </section>

          <section>
            <h2 className="text-2xl font-semibold mb-4 text-text-primary">2. Hébergement</h2>
          ...
          <section>
            <h2 className="text-2xl font-semibold mb-4 text-text-primary">3. Propriété intellectuelle</h2>
            <p>L'ensemble de ce site relève de la législation française et internationale sur le droit d'auteur et la propriété intellectuelle. Tous les droits de reproduction sont réservés, y compris pour les documents téléchargeables et les représentations iconographiques et photographiques.</p>
          </section>

          <section>
            <h2 className="text-2xl font-semibold mb-4 text-text-primary">4. Liens hypertextes</h2>
          ...
          <section>
            <h2 className="text-2xl font-semibold mb-4 text-text-primary">5. Responsabilité</h2>
