  ...
  return (
    <Layout>
      <div className="container mx-auto px-4 py-16">
        <h1 className="text-4xl font-bold mb-8 text-text-primary">Politique de Confidentialité</h1>
        
        <div className="space-y-8 text-text-secondary">
          <section>
            <h2 className="text-2xl font-semibold mb-4 text-text-primary">1. Collecte des informations</h2>
          ...
          <section>
            <h2 className="text-2xl font-semibold mb-4 text-text-primary">2. Utilisation des informations</h2>
          ...
          <section>
            <h2 className="text-2xl font-semibold mb-4 text-text-primary">3. Protection des informations</h2>
          ...
          <section>
            <h2 className="text-2xl font-semibold mb-4 text-text-primary">4. Vos droits</h2>
          ...
          <section>
            <h2 className="text-2xl font-semibold mb-4 text-text-primary">5. Contact</h2>
            ...
            <ul className="list-disc ml-6 mt-2 space-y-2">
              <li>Par email : contact@tolarys.fr</li>
